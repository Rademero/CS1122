...
public interface FindPi {
     ...
     * * @param num1 * @param num2 * @return the greastes common divisor of num1 and num2 */
     ...
     * * @param range is the number of calls to GCD with random inputs * @return */
